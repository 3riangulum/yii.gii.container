...
namespace Triangulum\Yii\GiiContainer\generators\crud;

use Triangulum\Yii\GiiContainer\CustomModuleGeneratorTrait;
use Yii;
 ...
 * @property-read TableSchema|bool $tableSchema      This property is read-only.
...
{
    use CustomModuleGeneratorTrait;
    ...
    public function rules()
    {
        ...
        return array_merge($rules, $this->rulesModule());
    }
    ...
    public function generate()
    {
        $params = [
            ...
            'logVar'   => $this->getLogVar(),

            'cacheUse'   => $this->getCacheUse(),
